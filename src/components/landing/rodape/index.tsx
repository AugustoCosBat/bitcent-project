    ...
    return (
        <Area className="bg-black py-20">
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center mt-14">
                ...
                <span className="text-purple-500">A</span><span className="font-bold">ugusto<span className="text-purple-500">C</span>os</span><span className="text-purple-500">B</span>at  ® {new Date().getFullYear()} - Todos os direitos reservados
                </p>
            </div>
        </Area>
    )
